...
API_SECRET_KEY=sk_test_51RjhiwR3JT7OlF40TfCO5IV8FX3W0Xs6zHOyQfTJXWwBrpd3eXJKVUgZK2UxzdEbFYO63mRJSA0gEYVckXoz0c5z00CrkQNquT

# add the key on the .env file 
# command 'npm install' on the project terminal than command 'nodemon index.js' for run the server
